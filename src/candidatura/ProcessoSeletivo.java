...
public class ProcessoSeletivo {
    ...
    static void entrandoEmContato(String cadidato) {
        ...
        do {
        	...
        	System.out.println("CONSEGUIMOS CONTATO COM " + cadidato + " NA " + tentativasRealizadas + " TENTATIVA ");
        }else {
        	System.out.println("NÃO CONSEGUIMOS CONTATO COM " + cadidato + ", NÚMEROS MAXIMO DE TENTATIVAS " + tentativasRealizadas + " REALIZADA");
        }
    }
